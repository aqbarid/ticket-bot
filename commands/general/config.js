	...
	run: async (client, interaction, args) => {
		...
		await interaction.reply({embeds: [
			new MessageEmbed()
				...
				.setDescription("Hei ini adalah sistem konfigurasi! \ Di mana Anda memiliki opsi untuk mengkonfigurasi bot.")
				.addField("Saluran transkrip "," Atur saluran di mana transkrip akan dikirim.")
				.addField("Staff Role", "Atur role yang dapat mengakses bot")
				.addField("Staff Mention", "Atur Role yang di mention setiap kali ada yang membuka tiket.")
				.setColor("#2f3136")
				.setFooter({text: "NKRI Support", iconURL: client.user.displayAvatarURL({dynamic: true})})
		], components: [
